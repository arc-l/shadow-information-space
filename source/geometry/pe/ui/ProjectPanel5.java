...
public class ProjectPanel5 extends BasePanel {
	...
	public ProjectPanel5() {
		...
		path.addPoint(new Point2D.Double(633.93,712.29));
		path.addPoint(new Point2D.Double(688.57,657.50));
...
//
		...
		Oracle o = new SingleTypeAgentOracle(1000000);
		o.initialize(gapss);
